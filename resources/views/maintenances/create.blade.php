<x-layouts.app 
    title="Maintenance Entry - CNC-08 | MRM System"
    :sidebar="false"
    :topbar="false"
>
    <!-- Custom Entry Header -->
    <header class="fixed top-0 right-0 left-0 h-16 bg-surface-bright border-b border-outline-variant z-50 flex items-center px-4 md:px-margin-desktop shadow-sm">
        ...
        <div class="flex flex-col">
            <h1 class="font-headline-sm text-headline-sm font-bold text-on-surface">Maintenance Record: CNC-08</h1>
            <span class="font-label-sm text-label-sm text-primary uppercase tracking-wider">Asset ID: 08-PROD-LATHE</span>
        </div>
        <div class="ml-auto flex items-center gap-3">
            <div class="hidden sm:block text-right">
                <p class="font-label-md text-label-md font-bold">TECH: R. MILLER</p>
                <p class="font-label-sm text-label-sm text-on-surface-variant">09:12 AM LOCAL</p>
            </div>
    ...
    <main class="mt-16 pb-24 max-w-2xl mx-auto px-4 pt-6">
        ...
        <div class="mb-8 p-4 bg-green-50 border border-green-200 text-green-800 rounded-lg flex items-center gap-3">
            ...
            <div class="text-body-sm">
                <strong>QR Scan Verified.</strong> Location: Machining Wing B, Bay 4. Connection established with Telemetry Cloud.
            </div>
        </div>
        ...
        <form action="{{ route('maintenances.index') }}" method="GET" class="space-y-8">
            ...
            <section class="space-y-3">
                <h3 class="font-headline-sm text-[16px] font-bold text-on-surface flex items-center gap-2">
                    <span class="text-primary font-bold text-[18px]">1.</span> Select Treatment Category
                </h3>
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <label class="relative flex flex-col p-4 bg-surface-container-lowest border border-outline-variant rounded-xl cursor-pointer hover:bg-surface-container-low transition-all">
                        ...
                        <span class="font-body-md font-semibold text-on-surface">Scheduled</span>
                        <span class="text-[11px] text-on-surface-variant mt-1">Routine checkup & care</span>
                    </label>
                    <!-- Corrective -->
                    <label class="relative flex flex-col p-4 bg-surface-container-lowest border border-outline-variant rounded-xl cursor-pointer hover:bg-surface-container-low transition-all">
                        ...
                        <span class="font-body-md font-semibold text-on-surface">Corrective</span>
                        <span class="text-[11px] text-on-surface-variant mt-1">Fix active breakdowns</span>
                    </label>
                    <!-- Predictive -->
                    <label class="relative flex flex-col p-4 bg-surface-container-lowest border border-outline-variant rounded-xl cursor-pointer hover:bg-surface-container-low transition-all">
                        ...
                        <span class="font-body-md font-semibold text-on-surface">Predictive</span>
                        <span class="text-[11px] text-on-surface-variant mt-1">Based on telemetry</span>
                    </label>
                </div>
            </section>
            ...
            <section class="space-y-3">
                <h3 class="font-headline-sm text-[16px] font-bold text-on-surface flex items-center gap-2">
                    <span class="text-primary font-bold text-[18px]">2.</span> Clinical Checklist
                </h3>
                <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 divide-y divide-outline-variant">
                    <label class="flex items-center justify-between py-3 cursor-pointer first:pt-0 last:pb-0">
                        <span class="font-body-md text-on-surface">Coolant Pressure Calibration</span>
                        <input type="checkbox" class="rounded text-primary focus:ring-primary h-5 w-5" checked />
                    </label>
                    <label class="flex items-center justify-between py-3 cursor-pointer first:pt-0 last:pb-0">
                        <span class="font-body-md text-on-surface">Axis Lubrication Points Checked</span>
                        <input type="checkbox" class="rounded text-primary focus:ring-primary h-5 w-5" checked />
                    </label>
                    <label class="flex items-center justify-between py-3 cursor-pointer first:pt-0 last:pb-0">
                        <span class="font-body-md text-on-surface">Chip Conveyor Debris Clearance</span>
                        <input type="checkbox" class="rounded text-primary focus:ring-primary h-5 w-5" />
                    </label>
                    <label class="flex items-center justify-between py-3 cursor-pointer first:pt-0 last:pb-0">
                        <span class="font-body-md text-on-surface">Spindle Runout Measurement</span>
                        <input type="checkbox" class="rounded text-primary focus:ring-primary h-5 w-5" />
                    </label>
                </div>
            </section>
            ...
            <section class="space-y-3">
                <div class="flex justify-between items-center">
                    <h3 class="font-headline-sm text-[16px] font-bold text-on-surface flex items-center gap-2">
                        <span class="text-primary font-bold text-[18px]">3.</span> Spareparts Replaced
                    </h3>
                    <span class="font-label-sm text-label-sm text-green-600 bg-green-50 px-2 py-0.5 rounded">WMS Live Sync</span>
                </div>
                
                <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 space-y-4">
                    <div class="relative">
                        <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-[20px]">search</span>
                        <input class="w-full pl-10 pr-4 py-2 bg-surface-container-low border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary font-body-md" placeholder="Search WMS Parts catalog (e.g. bearings, belts)..." type="text" />
                    </div>
            ...
            <section class="space-y-3">
                <h3 class="font-headline-sm text-[16px] font-bold text-on-surface flex items-center gap-2">
                    <span class="text-primary font-bold text-[18px]">4.</span> Clinical Observations
                </h3>
                <textarea rows="4" class="w-full bg-surface-container-lowest border border-outline-variant rounded-xl p-4 focus:ring-2 focus:ring-primary font-body-md text-on-surface" placeholder="Detail any anomalies, micro-vibrations, thermal leakage patterns, or future prescription recommendations..."></textarea>
            </section>

            <!-- 5. Evidence Captures -->
            <section class="space-y-3">
                <h3 class="font-headline-sm text-[16px] font-bold text-on-surface flex items-center gap-2">
                    <span class="text-primary font-bold text-[18px]">5.</span> Evidence Captures
                </h3>
                <div class="grid grid-cols-2 gap-4">
                    <div class="border border-dashed border-outline-variant p-6 rounded-xl flex flex-col items-center justify-center text-center cursor-pointer hover:bg-surface-container-low transition-colors">
                        ...
                        <span class="font-body-md text-body-md font-semibold text-on-surface">Before Treatment</span>
                        <span class="text-[11px] text-on-surface-variant mt-1">Upload symptom photo</span>
                    </div>
                    <div class="border border-dashed border-outline-variant p-6 rounded-xl flex flex-col items-center justify-center text-center cursor-pointer hover:bg-surface-container-low transition-colors">
                        <span class="material-symbols-outlined text-[36px] text-on-surface-variant mb-2">add_a_photo</span>
                        <span class="font-body-md text-body-md font-semibold text-on-surface">After Treatment</span>
                        <span class="text-[11px] text-on-surface-variant mt-1">Upload repaired state</span>
                    </div>
                </div>
            </section>
            ...
            <section class="space-y-3">
                <div class="flex justify-between items-center">
                    <h3 class="font-headline-sm text-[16px] font-bold text-on-surface flex items-center gap-2">
                        <span class="text-primary font-bold text-[18px]">6.</span> Physician's Signature
                    </h3>
                    <button type="button" id="clear-signature" class="text-primary font-label-md text-label-md hover:underline">Clear</button>
                </div>
                <div class="relative border border-outline-variant bg-surface-container-lowest rounded-xl overflow-hidden shadow-inner">
                    ...
                    <div id="signature-placeholder" class="absolute inset-0 flex items-center justify-center pointer-events-none text-on-surface-variant opacity-30 select-none">
                        <p class="font-label-md text-label-md tracking-widest uppercase">SIGN WITHIN THIS AREA</p>
                    </div>
                </div>
            </section>
